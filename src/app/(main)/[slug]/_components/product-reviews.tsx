...
const REVIEWS: Review[] = [
    {
        id: 1,
        text:
            "Built-in battery (5V/500mA charging) supports hours of playtime. LED indicators keep you informed of battery status and charging progress",
    ...
    return (
        <Box id="#product-reviews">
            ...
            <Box bgcolor="transparent">
                            ...
                            {distribution.map((item) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <Typography
                                            variant="body2"
                                            sx={{ width: 34, textAlign: "right", color: "text.secondary" }}
                                        >
                                            {item.count}
                                        </Typography>
                                    </Stack>
                        ...
                        <React.Fragment key={r.id}>
                            ...
                            >
                                ...
                                >
                                    ...
                                    />
                                    <Separator />
                                    <Typography variant="body2">By {r.author}</Typography>
                                    <Separator />
                ...
                >
                    <Pagination count={4} page={1} shape="rounded" variant="outlined" color="primary" />
                </Box>
            </Box>
        </Box>
...
function StatCard({
    ...
    return (
        <Box
            ...
            aria-label={label}
        >
            <Typography variant="h4" sx={{ color: "text.secondary", fontWeight: 400, mb: 0.5 }}>
                {label}
            </Typography>
