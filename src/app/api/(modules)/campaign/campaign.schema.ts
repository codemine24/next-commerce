...
export const createCampaign = z.object({
  body: z
    .object({
      title: z
        .string({
          error: "Title should be a text",
        })
        .min(4, "Title must be at least 4 characters long")
        .max(100, "Title must not exceed 100 characters"),
      sub_title: z
        .string({ error: "Sub title should be a text" })
        .optional()
        .nullable(),
      description: z
        .string({ error: "Description should be a text" })
        .optional()
        .nullable(),
      thumbnail: z
        .string({
      ...
      platform: z
        .enum(Object.values(CampaignPlatform) as [string, ...string[]])
        .optional(),
      conditions: z
